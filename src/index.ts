...
import { isAdmin,hashPassword,VerificationCode, isAuth, setClientIP, hashNewPassword } from './middleware'
import { env } from './env'
...
app.use('/log-in',[setClientIP],adminRoutes.logInRouter)
...
app.listen(PORT,()=> {
    ...
    Speaker.enqueue('server is running')
})
